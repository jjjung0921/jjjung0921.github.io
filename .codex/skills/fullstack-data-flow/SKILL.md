...
description: Portfolio integration skill for future frontend/backend or external API contracts, request/response tracing, CORS/auth/status-code diagnosis, and data-shape mismatch analysis.
---
...
This portfolio is currently a static Astro site. Do not invent a backend. Only use this skill when an integration exists or is being designed.
