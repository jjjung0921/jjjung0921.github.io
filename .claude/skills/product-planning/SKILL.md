...
description: Use when deciding what the portfolio should contain — whether a page, link, or feature helps a busy reviewer (lab PI, recruiter, collaborator) understand the person, get the CV, and reach concrete work quickly.
---
...
1. Read the current goal source: `CLAUDE.md`, `AGENTS.md`, `README.md`, and relevant pages under `src/pages/`.
